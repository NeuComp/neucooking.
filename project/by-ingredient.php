            ...
            <div class="mx-auto col-12 col-sm-12 col-md-10 col-lg-9 margin-to-footer">
                ...
                <div class="content-start row g-3">
                    <div class="col-12 align-items-center">
                        ...
                        <h2 class="text-center fs-2 mt-md-5">By Ingredient</h2>
                        <p class="lead text-muted text-center fs-5">Search for meals based on the ingredients you already have.</p>
                        <form class="d-flex justify-content-center mb-md-5">
                            <input class="form-control me-2 rounded-4 shadow-sm" type="search" placeholder="Search seafood.." aria-label="Search" style="max-width: 470px">
                    ...
                    <div class="g-3 mt-4">
                        <div class="d-none d-md-flex">
                            ...
                            <h5>Most popular By Ingredient recipies</h5>
                        </div>
